            ...
            <div className="max-w-[500px] mb-10">
                <LazyReveal triggerOnce={true} className="flex flex-col gap-5">
                    <LazyReveal  triggerOnce={true}>
                        ...
                        <h1 className="text-5xl font-bold"><TypingAnimate kalimat={['Asisten Praktikum Lab Rekayasa Perangkat Lunak', 'Back-end Developer at Sekolah Kopi RAISA', 'Demisioner UKM-KI Al-Azhar']} /></h1>
                    </LazyReveal>
